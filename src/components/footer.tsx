function Footer() {
  return (
    <footer className="mt-10 w-full">
      <div className="w-full py-5 px-5 md:flex md:items-center md:justify-between">
        <a
          href="https://alejandro-alejandro-velezs-projects.vercel.app/"
          className="text-gray-300"
        >
          Alejandro Velez Gomez 🦀
        </a>
        <div className="inline-flex justify-center items-center gap-2">
          <a href="https://github.com/MelonConYogurt/new-astro-project">
            <svg
              viewBox="0 0 256 250"
              width="1.5rem"
              height="1.5rem"
